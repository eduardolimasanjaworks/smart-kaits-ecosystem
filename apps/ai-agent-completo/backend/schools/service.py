...
_MOCK_PROVISION_DEFAULT_AGENT: dict = {
    ...
    "tools": {
        "consultCourses": False,
        "consultCoursesTriggers": [],
        "consultStages": False,
        "consultStagesTriggers": [],
        "consultClasses": False,
        "consultClassesTriggers": [],
        "consultClassSchedule": False,
        "consultClassScheduleTriggers": [],
        "consultPricing": False,
        "consultPricingTriggers": [],
        "listClassStudents": False,
        "listClassStudentsTriggers": [],
        "checkSchedule": False,
        "checkScheduleTriggers": [],
        "getStudentDetails": False,
        "getStudentDetailsTriggers": [],
        "consultCourseProgram": False,
        "consultCourseProgramTriggers": [],
        "consultTeachers": False,
        "consultTeachersTriggers": [],
        "consultDocuments": False,
        "consultDocumentsTriggers": [],
        "enrollStudent": False,
